...
function WebSocketClient(url, protocols, userOptions) {
  var realWs = {
    close: function () {}
  },
      connectTimeout,
      ...
      pendingReconnect,
      opts = Object.assign({}, WebSocketClient.defaultOptions, typeof userOptions === 'function' ? {
...
WebSocketClient.prototype.binaryType = 'blob'; // Taken from MDN https://developer.mozilla.org/en-US/docs/Web/API/EventTarget
