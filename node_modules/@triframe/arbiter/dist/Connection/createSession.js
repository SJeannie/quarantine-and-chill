...
let encrypt = (payload, secret) => new Promise(resolve => (0, _jsonwebtoken.sign)(payload, secret, (err, token) => resolve(token)));

let decrypt = (token, secret) => new Promise(resolve => (0, _jsonwebtoken.verify)(token, secret, (err, payload) => resolve(payload)));
...
const createSession = exports.createSession = model => {
  const bin = {};
  ...
  const crawl = (model, namespace) => {
    class Session {
      constructor(attributes = {}, agent = null, pipes = [], callback = () => null) {
        ...
        this['[[agent]]'] = agent ? agent : new _core.EventEmitter();
      ...
      if (typeof value === 'object' && value !== null && !Array.isArray(value)) {
        ...
        Object.defineProperty(Session.prototype, key, {
          get() {
            ...
            if (this['[[pipes]]'].find(oldPipe => oldPipe.isEqual(newPipe))) newPipe.destroy();else this['[[pipes]]'].push(newPipe);
