...
const index = function (subject, index = '_id', select = false, coalesceValue = undefined) {
  ...
  let selectionOf;
  if (typeof select == 'function') selectionOf = select;else if (select) selectionOf = (key, value) => value[select];else selectionOf = (key, value) => value;
...
function deepMerge(obj1, obj2) {
  switch (typeof obj2) {
    case "object":
      ...
      return _objectSpread(_objectSpread({}, obj1), map(obj2, (k, obj2) => deepMerge(obj1[k], obj2)));
