...
inflection.UNCOUNTABLE_WORDS = ['equipment', 'information', 'rice', 'money', 'species', 'series', 'fish', 'sheep', 'moose', 'deer', 'news'];
/**
 * Translation rules
...
inflection.TITLE_LOWERCASE_WORDS = ['and', 'or', 'nor', 'a', 'an', 'the', 'so', 'but', 'to', 'of', 'at', 'by', 'from', 'into', 'on', 'onto', 'off', 'out', 'in', 'over', 'with', 'for'];
/**
...
inflection.toPlural = function (str) {
  return inflection.applyRules_(str, inflection.Rules.SINGULAR_TO_PLURAL, inflection.UNCOUNTABLE_WORDS);
};
/**
...
inflection.toSingular = function (str) {
  return inflection.applyRules_(str, inflection.Rules.PLURAL_TO_SINGULAR, inflection.UNCOUNTABLE_WORDS);
};
/**
...
inflection.replaceNumbersWithOrdinals = function (str) {
  return str.replace(inflection.CommonRegExp.NUMBERS, function (num) {
    ...
    if (tens !== 1) {
      if (singles === 1) return num + 'st';else if (singles === 2) return num + 'nd';else if (singles === 3) return num + 'rd';
    }
...
const isPlural = exports.isPlural = word => toPlural(word) === word;

const isSingular = exports.isSingular = word => toSingular(word) === word;

const toPlural = exports.toPlural = inflection.toPlural;
const toSingular = exports.toSingular = inflection.toSingular;
const toCamelCase = exports.toCamelCase = inflection.toCamelCase;
const toPascalCase = exports.toPascalCase = inflection.toPascalCase;
const toTitleCase = exports.toTitleCase = inflection.toTitleCase;
const toDashed = exports.toDashed = inflection.toDashed;
const toUnderscored = exports.toUnderscored = inflection.toUnderscored;
const toHumanized = exports.toHumanized = inflection.toHumanized;
const toCapitalized = exports.toCapitalized = inflection.toCapitalized;
const toTableName = exports.toTableName = inflection.toTableName;
const toClassName = exports.toClassName = inflection.toClassName;
const toForeignKeyName = exports.toForeignKeyName = inflection.toForeignKeyName;
const replaceNumbersWithOrdinals = exports.replaceNumbersWithOrdinals = inflection.replaceNumbersWithOrdinals;
const toColumnName = exports.toColumnName = inflection.toColumnName;
